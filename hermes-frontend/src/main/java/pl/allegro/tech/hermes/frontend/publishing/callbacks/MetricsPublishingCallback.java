...
public class MetricsPublishingCallback implements PublishingCallback {
    ...
    public MetricsPublishingCallback(HermesMetrics hermesMetrics, Topic topic) {
        ...
        latencyTimerPerTopic = hermesMetrics.timer(Timers.PRODUCER_BROKER_LATENCY, topic.getName()).time();
    }
    ...
    public void onPublished(Message message, Topic topic) {
        ...
        hermesMetrics.meter(Meters.PRODUCER_METER, topic.getName()).mark();
